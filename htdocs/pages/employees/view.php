...
<h1>사원상세</h1>
    ...
    <?php if ($photo): ?>
        <img src="/<?php echo $photo[0]['path'] . $photo[0]['file_name']; ?>" alt="Profile Picture" width="100" height="100" /><br />
    <?php else: ?>
        <img src="/default-photo.jpg" alt="Default Profile Picture" width="100" height="100" /><br />
    <?php endif; ?>
